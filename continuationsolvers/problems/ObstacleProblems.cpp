...
ObstacleProblem::ObstacleProblem(mfem::ParFiniteElementSpace* fesU_, mfem::ParFiniteElementSpace* fesM_,
...
ObstacleProblem::ObstacleProblem(mfem::ParFiniteElementSpace* fesU_, mfem::ParFiniteElementSpace* fesM_,
                                 mfem_fun_ptr_type fSource, mfem_fun_ptr_type obstacleSource,
...
// Parametrized Obstacle Problem
// Hessian of energy term is K + M (stiffness + mass)
ParamObstacleProblem::ParamObstacleProblem(mfem::ParFiniteElementSpace* fesU_, mfem_fun_ptr_type fSource,
...
// Hessian of energy term is K + M (stiffness + mass)
ParamObstacleProblem::ParamObstacleProblem(mfem::ParFiniteElementSpace* fesU_, mfem_fun_ptr_type fSource,
                                           mfem_fun_ptr_type obstacleSource, mfem::Array<int> tdof_list,
                                           mfem::Vector& ud)
    : ParamOptProblem()
{
  Vh = fesU_;
...
mfem::Operator* ParamObstacleProblem::DddE(const mfem::Vector& d, const mfem::Vector& theta) { return &K; }

mfem::Operator* ParamObstacleProblem::DdthE(const mfem::Vector& d, const mfem::Vector& theta) { return HdthE.get(); }
...
mfem::Operator* ParamObstacleProblem::Ddg(const mfem::Vector& d, const mfem::Vector& theta) { return Jd.get(); }

mfem::Operator* ParamObstacleProblem::Dthg(const mfem::Vector& d, const mfem::Vector& theta) { return Jth.get(); }
